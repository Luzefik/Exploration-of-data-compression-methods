...
- `init` - зберігає основу програми, усі віджети та візуал сторінки
- `pick_file` - функція, яка обробляє запит користувача на кнопку `pick a file`, перевіряє чи вибраний користувачем файл є правильного розширення та повідомляє йому, якщо це не так
